package kz.garage.chat.ui.keyboard

import android.os.Bundle
import android.view.View
import com.google.android.material.button.MaterialButton
import kz.garage.chat.ui.R
import kz.garage.chat.ui.keyboard.model.UIKeyboard
...
internal class InlineKeyboardAdapter constructor(
    ...
    layoutId = R.layout.chat_ui_cell_inline_button
) {
...
//                    Logger.debug(TAG, "payload: $payload")
    ...
    private inner class ViewHolder constructor(
        ...
        fun setSelectedState() {
            val backgroundTintList = getColorStateListCompat(R.color.chat_ui_button_bg_light_blue_to_gray)
            val textColorStateList = getColorStateListCompat(R.color.chat_ui_button_text_white_to_light_black)
        ...
        fun setUnselectedState() {
            val backgroundTintList = getColorStateListCompat(R.color.chat_ui_button_bg_gray_to_light_blue)
            val textColorStateList = getColorStateListCompat(R.color.chat_ui_button_text_light_black_to_white)
